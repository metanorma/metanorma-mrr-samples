...
[requirement,type="pseudocode",label="/iid-testing/permutation-test/",classification="control-class:Technical;priority:P0;family:System and Communications Protection,System and Communications Protocols"]
====
